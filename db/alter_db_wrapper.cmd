...
for /f "delims=|" %%a in ('dir /B /S alter_db.sql') do psql  -h %HOST_NAME% -p %PORT_NUMBER% -d %DATABASE_NAME% -U %USER_NAME% -f %%a -v FILE_PATH=%CURRENT_DIR%/ -v TABLE_OWNER=%USER_NAME%
